...
class TestHist1D(unittest.TestCase):
  ...
  def test_timeseries(self):
    ...
    s.add_offsets(2500)
    self.assertEqual(s.times[4], 2500)
    s.add_offsets_s(2.5)
    self.assertEqual(s.times[6], 2.5 * ns_per_second)
    s.add_offsets_ms(250.0)
    self.assertEqual(s.times[5], 250000000)
    s.add_offsets([30910, 35801])
    self.assertEqual(s.times[5], 30910)
    self.assertEqual(s.times[6], 35801)
    s.add_offsets_s([10.5, 12.25])
    self.assertEqual(s.times[11], 10.5 * ns_per_second)
    self.assertEqual(s.times[12], 12.25 * ns_per_second)
    s.add_offsets_ms([15750, 18125])
    self.assertEqual(s.times[13], 15.75 * ns_per_second)
    self.assertEqual(s.times[14], 18.125 * ns_per_second)
    # check that (4,4) vs [4,4] ambiguity resolved in add_times
    s.add_times((4,4))
    self.assertEqual(s.times[8], ns_per_second - 1)
    s.add_times([4,4])
    self.assertEqual(s.times[8], ns_per_second - 5)
    self.assertEqual(s.times[9], ns_per_second - 5)
    self.assertEqual(s.times[10], ns_per_second - 1)
    s.add_times(np.array([5,5]))
    self.assertEqual(s.times[11], 2 * ns_per_second - 5)
    self.assertEqual(s.times[12], 2 * ns_per_second - 5)
