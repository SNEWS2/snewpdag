...
class TestShape(unittest.TestCase):
  ...
  def test_update(self):
    n1 = Shape(500, -0.2, 0.3, 5, -0.04, 0.0005, 160, 4, 0.01, 0, 0, 0, name = 'Node1')
    n2 = Shape(500, -0.2, 0.3, 5, -0.04, 0.0005, 160, 4, 0.01, 1, 0.001, 0, name = 'Node2')
    n3 = Shape(500, -0.2, 0.3, 5, -0.04, 0.0005, 160, 4, 0.01, 2, 0.001, 0.03, name = 'Node3')
