...
from snewpdag.plugins import Bayes

class TestShape(unittest.TestCase):

  def test_update(self):
    shapehist = ShapeHist(500, -0.2, 0.3)
    shape = Shape(shapehist, 5.0, -0.04, 0.0005, 160, 4, 0.01, name = 'Node1')
    bayes = Bayes(shapehist, shape, 0.001, 0.03, name = 'Node2')
    ...
    bayes.update_Bayes(data[0])
    bayes.update_Bayes(data[1])
