...
class TestValidator(unittest.TestCase):
    ...
    def test_plugin0(self):
        h1 = ValidateKey(search_key = 'action', on_alert = 'alert', name = 'val0')
        h2 = ValidateKeyType(key_type = 'str', on_alert = 'alert', name = 'val1')
        data = [
            {'action': 'alert'},
            {'dt': 1.0},
        ]
    ...
    def test_plugin1(self):
        h1 = ValidateKey(search_key = 'dt', on_alert = 'alert', name = 'val0')
        h2 = ValidateKeyType(key_type = 'float', on_alert = 'alert', name = 'va1')
        data = [
            {'action': 'alert'},
            {'dt': 1.0},
        ]
    ...
    def test_plugin2(self):
        h1 = History()
        h1.append('Input1')
        h2 = ValidateKeyType(key_type = 'History', on_alert = 'alert', name = 'val0')
        data = [
            {'history': h1},
        ]
        print('\n-----Test3-----')
    ...
    def test_plugin3(self):
        h1 = ValidateListType(max_fraction = 0.1, key_type = 'float', on_alert = 'alert', name = 'val0')
        h2 = ValidateListType(max_fraction = 0.1, key_type = 'str', on_alert = 'alert', name = 'val1')
        data = [
    ...
    def test_plugin5(self):
        h1 = ValidateSort(list_order = 'ascending', on_alert = 'alert', name = 'val0')
        data = [
        ...
        print('\n-----Test6-----')
        self.assertEqual(h1.check_sorted(data[0]['dt']), ([0.0, 0.5, 1.0, 3.2, 5.3], 'ascending'))
        self.assertEqual(h1.check_sorted(data[1]['dt']), ([5.3, 3.2, 1.0, 0.5, 0.0], 'descending'))
        self.assertEqual(h1.check_sorted(data[2]['dt']), ([0.0, 0.5, 1.0, 3.2, 5.3], 'ascending'))
